...
import { FLOTAS, PRIORIDADES, SUPERINTENDENCIAS, COORDINADORES_LISTA, AREAS_ENTREGA, MAX_TRABAJOS_CLIENTE } from '../constants';
import { inputCls, selectCls, btnPrimario, btnSecundario } from '../ui';
import TrabajosRequeridos from './TrabajosRequeridos';
import FormatoImpreso from './FormatoImpreso';
    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmit} className="bg-white rounded-2xl border border-slate-200 shadow-sm mt-4 overflow-hidden">
                ...
                <Seccion
                    numero={2}
                    titulo="Trabajos requeridos"
                    descripcion={`Una fila por trabajo: su categoría y un solo tipo de requerimiento. Hasta ${MAX_TRABAJOS_CLIENTE}.`}
                >
                    <TrabajosRequeridos
                        trabajos={formData.Trabajos}
                        onChange={(t) => set('Trabajos', t)}
                    />
                </Seccion>
